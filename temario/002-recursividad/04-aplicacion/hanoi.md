...
Esto conecta directamente con el **[Paso 06](../03-implementacion/06-multiples-llamadas-ambas.md)**: dos llamadas recursivas que se ejecutan ambas, con una operación intercalada entre ellas. La estructura es idéntica al inorder de un árbol binario, pero el problema es completamente distinto.
...
> El código completo, incluyendo una versión con visualización paso a paso y una traza de llamadas, está en [Hanoi.java](../../../src/recursividad/Hanoi.java).
